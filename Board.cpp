...
void Board::printBoard() { 
    ...
    cout <<"              " << structurePlaces[3].getPrintableString() << "   10   " << structurePlaces[4].getPrintableString() << "    2    " << structurePlaces[5].getPrintableString() << "    9    " << structurePlaces[6].getPrintableString() << "\033[0m" << endl;
    cout <<"              " << roadPlaces[6].getPrintableString() << "|\033[0m   " << "🪨    " << roadPlaces[7].getPrintableString() << "|\033[0m   " << "🐑    " << roadPlaces[8].getPrintableString() << "|\033[0m   " << "🌲    " << roadPlaces[9].getPrintableString() << "|\033[0m" << endl;
    cout <<"              " << structurePlaces[7].getPrintableString() << "        " << structurePlaces[8].getPrintableString() << "         " << structurePlaces[9].getPrintableString() << "         " << structurePlaces[10].getPrintableString() << "\033[0m" << endl;
    cout <<"          " << roadPlaces[10].getPrintableString() << "  /  " << roadPlaces[11].getPrintableString() << " \\  " << roadPlaces[12].getPrintableString() << "  /  " << roadPlaces[13].getPrintableString() << " \\     " << roadPlaces[14].getPrintableString() << "/  " << roadPlaces[15].getPrintableString() << " \\" << roadPlaces[16].getPrintableString() << "     /  " << roadPlaces[17].getPrintableString() << " \\\033[0m" << endl;  
    cout <<"          " << structurePlaces[11].getPrintableString() << "  12   " << structurePlaces[12].getPrintableString() << "    6    " << structurePlaces[13].getPrintableString() << "    4    " << structurePlaces[14].getPrintableString() << "   10   " << structurePlaces[15].getPrintableString() <<"\033[0m" << endl;
    cout <<"          " << roadPlaces[18].getPrintableString() << "|\033[0m  " << "🌾   " << roadPlaces[19].getPrintableString() << "|\033[0m   " << "🧱    " << roadPlaces[20].getPrintableString() << "|\033[0m   " << "🐑    " << roadPlaces[21].getPrintableString() << "|\033[0m   " << "🧱   " << roadPlaces[22].getPrintableString() << "|\033[0m" << endl;
    cout <<"          " << structurePlaces[16].getPrintableString() << "       " << structurePlaces[17].getPrintableString() << "         " << structurePlaces[18].getPrintableString() << "         " << structurePlaces[19].getPrintableString() << "        " << structurePlaces[20].getPrintableString() << "\033[0m" << endl;
    ...
    cout <<"       " << structurePlaces[27].getPrintableString() << "      " << structurePlaces[28].getPrintableString() << "        " << structurePlaces[29].getPrintableString() << "         " << structurePlaces[30].getPrintableString() << "        " << structurePlaces[31].getPrintableString() << "        " << structurePlaces[32].getPrintableString() << "\033[0m" << endl;
    cout <<"       " << roadPlaces[39].getPrintableString() << " \\ " << roadPlaces[40].getPrintableString() << "  /  " << roadPlaces[41].getPrintableString() << " \\  " << roadPlaces[42].getPrintableString() << "  /  " << roadPlaces[43].getPrintableString() << " \\    " << roadPlaces[44].getPrintableString() << " /  " << roadPlaces[45].getPrintableString() << " \\  " << roadPlaces[46].getPrintableString() << "  /  " << roadPlaces[47].getPrintableString() << " \\ " << roadPlaces[48].getPrintableString() << "    /  ""\033[0m" << endl;
    cout <<"          " << structurePlaces[33].getPrintableString() << "       " << structurePlaces[34].getPrintableString() << "         " << structurePlaces[35].getPrintableString() << "         " << structurePlaces[36].getPrintableString() << "        " << structurePlaces[37].getPrintableString() << "       " << "\033[0m" << endl;
    cout <<"          " << roadPlaces[49].getPrintableString() << "|\033[0m  " << " 8   " << roadPlaces[50].getPrintableString() << "|\033[0m  " << "  3    " << roadPlaces[51].getPrintableString() << "|\033[0m   " << " 4    " << roadPlaces[52].getPrintableString() << "|\033[0m   5    " << roadPlaces[53].getPrintableString() << "|\033[0m" << endl;
    cout <<"          " << structurePlaces[38].getPrintableString() << "  🌲   " << structurePlaces[39].getPrintableString() << "   🪨     " << structurePlaces[40].getPrintableString() << "    🌾   " << structurePlaces[41].getPrintableString() << "   🐑   " << structurePlaces[42].getPrintableString() << "\033[0m" << endl;
    cout <<"           " << roadPlaces[54].getPrintableString() << " \\ " << roadPlaces[55].getPrintableString() << "  /   " << roadPlaces[56].getPrintableString() << " \\ " << roadPlaces[57].getPrintableString() << "  /    " << roadPlaces[58].getPrintableString() << " \\  " << roadPlaces[59].getPrintableString() << " /   " << roadPlaces[60].getPrintableString() << " \\  " << roadPlaces[61].getPrintableString() << "  /   ""\033[0m" << endl;
    cout <<"              " << structurePlaces[43].getPrintableString() << "        " << structurePlaces[44].getPrintableString() << "         " << structurePlaces[45].getPrintableString() << "        " << structurePlaces[46].getPrintableString() <<"\033[0m" << endl;
    cout <<"              " << roadPlaces[63].getPrintableString() << "|\033[0m  " << "  6   " << roadPlaces[64].getPrintableString() << "|\033[0m   " << "8    " << roadPlaces[65].getPrintableString() << " |\033[0m   " << "🐑   " << roadPlaces[66].getPrintableString() << "|\033[0m   " << endl;
    cout << "              " << structurePlaces[47].getPrintableString() << "   🧱   " << structurePlaces[48].getPrintableString() << "   🌾    " << structurePlaces[49].getPrintableString() << "    5   " << structurePlaces[50].getPrintableString() << "\033[0m" << endl;
    cout << "              " << roadPlaces[66].getPrintableString() << "  \\ " << roadPlaces[67].getPrintableString() << "   / " << roadPlaces[68].getPrintableString() << "  \\    " << roadPlaces[69].getPrintableString() << " /  " << roadPlaces[70].getPrintableString() << " \\  " << roadPlaces[71].getPrintableString() << "  /  " << "\033[0m" << endl;
    cout << "                  " << structurePlaces[51].getPrintableString() << "         " << structurePlaces[52].getPrintableString() << "         " << structurePlaces[53].getPrintableString() << endl;
// NOLINTEND
}